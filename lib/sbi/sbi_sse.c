...
#define SBI_SSE_EVENT_LOCAL_RAS(_idx)	(SBI_SSE_EVENT_LOCAL_RAS_START + _idx)

static const uint32_t supported_events[] = {
	SBI_SSE_EVENT_LOCAL_RAS(0),
	SBI_SSE_EVENT_LOCAL_RAS(1),
	SBI_SSE_EVENT_LOCAL_RAS(2),
	SBI_SSE_EVENT_LOCAL_RAS(3),
	SBI_SSE_EVENT_LOCAL_RAS(4),
	SBI_SSE_EVENT_LOCAL_RAS(5),
	SBI_SSE_EVENT_LOCAL_RAS(6),
	SBI_SSE_EVENT_LOCAL_RAS(7),
	SBI_SSE_EVENT_LOCAL_RAS(8),
	SBI_SSE_EVENT_LOCAL_RAS(9),
	SBI_SSE_EVENT_GLOBAL_RAS_START,
