...
enum {
	RERI_ERR_NO_ERROR,			/* 0 */
	RERI_ERR_OTH_UNSPEC,			/* 1 */
	RERI_ERR_CORRUPTED_DATA_ACCESS,		/* 2 */
	RERI_ERR_CACHE_BLOCK_DATA,		/* 3 */
	RERI_ERR_CACHE_SCRUBBING_DETECTED,
	RERI_ERR_CACHE_ADDR_CTRL_STATE,
	RERI_ERR_CACHE_UNSPEC,
	RERI_ERR_SNOOP_FILTER_DIREC_ADDR,
	RERI_ERR_SNOOP_FILTER_DIREC_ADDR_UNSPEC,
	RERI_ERR_TLB_PAGE_CACHE_DATA,		/* 9 */
	RERI_ERR_TLB_PAGE_CACHE_ADDR_CONTROL,
	RERI_ERR_TLB_PAGE_CACHE_UNSPEC,
	RERI_ERR_HART_STATE,			/* 12 */
	RERI_ERR_INTERRUPT_CONTROLLER_STATE,
	RERI_ERR_INTERCONNECT_DATA,
	RERI_ERR_INTERCONNECT_OTHER,
	RERI_ERR_INTERNAL_WATCHDOG,
	RERI_ERR_INTERNAL_DATAPATH_MEM,
	RERI_ERR_SYS_MEM_COMMAND,
	RERI_ERR_SYS_MEM_UNSPEC,
	RERI_ERR_SYS_MEM_DATA,
	RERI_ERR_SYS_MEM_SCRUBBING,
	RERI_ERR_PROT_ILL_IO,
	RERI_ERR_PROT_ILL_UNSPEC,
	RERI_ERR_PROT_TIMEOUT,
	RERI_ERR_SYS_INT_CONT,
	RERI_ERR_DEF_ERR_PASSTHROUGH_NOT_SUPP,
	RERI_ERR_PCIE_CXL_DETECTED,
	/* 28 - 63 reserved */
	RERI_ERR_CUSTOM_1 = 64,
	RERI_ERR_CUSTOM_END = 255
};

/* Transaction Type (TT) encodings */
enum {
	TT_UNSPEC,
	TT_CUSTOM,
	TT_EXPLICIT_READ = 4,
